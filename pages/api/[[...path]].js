...
const queries = [
	...
	{ noun: "audio", key: 'type', query: "select * from media where ? order by project, collection, ordinal" },
	{ noun: "video", key: 'type', query: "select * from media where ? order by project, collection, ordinal" },
